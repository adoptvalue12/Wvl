-- ============================================================
-- Yuno Hub - Pet & Toy Spawner with Equip/Fly/Ride/Rename
-- Extracted from MockTrade.lua – full pet engine.
-- ============================================================
...
-- ============================================================
-- Spawn Helper Functions (same as before)
-- ============================================================
...
-- ============================================================
-- GUI – Yuno Hub with Pet Controls
-- ============================================================
...
petsPanel.Size = UDim2.new(1, 0, 0, 345)
...
-- ============================================================
-- Pet Controls (Equip, Ride, Fly, Rename)
-- ============================================================
local controlsPanel = Instance.new("Frame")
controlsPanel.Size = UDim2.new(1, 0, 0, 90)
...
Instance.new("UICorner", controlsPanel).CornerRadius = UDim.new(0, 4)
local cpStroke = Instance.new("UIStroke")
cpStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
cpStroke.Color = Color3.fromRGB(108, 75, 171)
...
local equipBtnRow = Instance.new("Frame")
equipBtnRow.Size = UDim2.new(1, 0, 0, 22)
equipBtnRow.BackgroundTransparency = 1
equipBtnRow.LayoutOrder = 1
equipBtnRow.Parent = controlsPanel
local ebrLayout = Instance.new("UIListLayout")
ebrLayout.FillDirection = Enum.FillDirection.Horizontal
ebrLayout.Padding = UDim.new(0, 4)
ebrLayout.SortOrder = Enum.SortOrder.LayoutOrder
ebrLayout.HorizontalAlignment = Enum.HorizontalAlignment.Center
ebrLayout.Parent = equipBtnRow
...
renameBox.BackgroundColor3 = Color3.fromRGB(40, 40, 50)
renameBox.Text = ""
...
renameBox.PlaceholderColor3 = Color3.fromRGB(90, 90, 110)
...
rStroke.Color = Color3.fromRGB(108, 75, 171)
rStroke.Thickness = 1
rStroke.Transparency = 0.3
rStroke.Parent = renameBtn

-- Functions to update controls based on equipped pet
...
print("Yuno Hub with pet controls loaded successfully!")