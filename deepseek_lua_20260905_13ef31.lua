...
-- FIX : les onglets fonctionnent parfaitement (retour à la structure éprouvée).
-- ============================================================
...
-- ============================================================
-- Pet Engine (extrait du PETS TAB du script original)
-- ============================================================
...
local function applyThemeAndFont(themeName, fontName)
    ...
    local function updateDescendants(obj)
        ...
        if obj:IsA("TextButton") and obj ~= closeBtn then
            obj.BackgroundColor3 = theme.buttonBg
            obj.TextColor3 = theme.text
        end
...
-- ============================================================
-- GUI – Yuno Hub (Polished) - STRUCTURE FIXEE
-- ============================================================
...
-- Content container avec un layout vertical
...
-- Layout pour empiler les éléments (tab container + panneaux)
...
-- ============================================================
-- Panneaux (LayoutOrder 1,2,3)
-- ============================================================
local petsPanel = Instance.new("Frame")
petsPanel.Size = UDim2.new(1, 0, 1, -28)  -- occupe tout l'espace restant (hauteur totale - hauteur des onglets)
...
toysPanel.BackgroundTransparency = 0.5 -- debug
...
themePanel.BackgroundTransparency = 0.5 -- debug

-- ============================================================
-- Contenu du panel Pets (inchangé)
-- ============================================================
...
-- ============================================================
-- Changement d'onglet (FIX DEFINITIF)
-- ============================================================
