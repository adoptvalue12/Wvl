-- ============================================================
-- Yuno Hub - Moteur complet + thèmes
-- Equip, Ride, Fly, Rename, Neon, Mega, Ailments (quêtes)
-- UI épurée, draggable, onglets fonctionnels.
-- ============================================================
...
if not ClientData or not InventoryDB or not KindDB then
    error("Modules requis non chargés (ClientData, InventoryDB, KindDB)")
end
...
-- ============================================================
-- Moteur des pets (extrait du PETS TAB original)
-- ============================================================
...
-- Déséquiper les pets existants au chargement
for _, w in pairs(ClientData.get("pet_char_wrappers") or {}) do
    ...
    local function updateDescendants(obj)
        if obj:IsA("TextLabel") or obj:IsA("TextButton") or obj:IsA("TextBox") then
            ...
            if obj:IsA("TextButton") or obj:IsA("TextLabel") then
                if obj ~= closeBtn and obj ~= titleLabel then
        ...
        if obj:IsA("TextButton") and obj ~= closeBtn and obj ~= titleLabel then
            obj.BackgroundColor3 = theme.buttonBg
            obj.TextColor3 = theme.text
        end
...
-- ============================================================
-- GUI – Yuno Hub (structure éprouvée)
-- ============================================================
...
-- Conteneur avec layout vertical (les onglets et les panneaux s'empilent)
...
-- ============================================================
-- Panneaux (LayoutOrder 1,2,3) – ils occupent tout l'espace restant
-- ============================================================
local petsPanel = Instance.new("Frame")
petsPanel.Size = UDim2.new(1, 0, 1, -28)  -- occupe toute la hauteur restante
...
toysPanel.Size = UDim2.new(1, 0, 1, -28)
toysPanel.BackgroundTransparency = 1
toysPanel.LayoutOrder = 2
toysPanel.Visible = false
toysPanel.Parent = content
-- Couleur temporaire pour confirmer la visibilité (sera masquée par le thème)
toysPanel.BackgroundColor3 = Color3.fromRGB(60, 30, 60)
toysPanel.BackgroundTransparency = 0.5

local themePanel = Instance.new("Frame")
themePanel.Size = UDim2.new(1, 0, 1, -28)
themePanel.BackgroundTransparency = 1
themePanel.LayoutOrder = 3
themePanel.Visible = false
themePanel.Parent = content
themePanel.BackgroundColor3 = Color3.fromRGB(30, 30, 80)
themePanel.BackgroundTransparency = 0.5

-- ============================================================
-- Contenu du Pets Panel (inchangé)
-- ============================================================
...
-- ============================================================
-- Commutation des onglets (fonctionnelle)
-- ============================================================
...
print("Yuno Hub avec onglets fonctionnels et moteur complet chargé !")