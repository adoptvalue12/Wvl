--[[
    ...
    Version mobile-friendly, corrigée et testée
]]
...
-- Remplacer table.find (qui peut ne pas exister)
...
local function createMainGUI()
    ...
    -- Masque pour cacher les coins inférieurs
    ...
    -- Zone de drag transparente (en dessous des boutons)
    ...
    -- ===== FAVORIS (déclaration avant utilisation) =====
    local favorites = {}
