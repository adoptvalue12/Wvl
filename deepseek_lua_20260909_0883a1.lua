--[[
    ...
    Style preppy, optimisé mobile, avec favoris et thèmes
    Toutes les valeurs proviennent des captures d'écran fournies
]]
...
-- ============================================================================
-- BASE DE DONNÉES DES VALEURS (issue des screenshots)
-- ============================================================================
local petValues = {
    -- Haut de gamme
    ["bat dragon"] = 943,
...
local function createMainGUI()
    ...
    mainFrame.Size = UDim2.new(0, 460, 0, 640)  -- taille fixe, adaptée mobile
    mainFrame.Position = UDim2.new(0.5, -230, 0.5, -320)
    mainFrame.BackgroundColor3 = Color3.fromRGB(252, 245, 250) -- pastel rose clair
    ...
    titleBar.BackgroundColor3 = Color3.fromRGB(255, 180, 200) -- rose preppy
    ...
    -- Bouton minimiser (réduit la fenêtre, mais ici on va juste la cacher ? on laisse pour l'exemple)
    local minBtn = Instance.new("TextButton")
    minBtn.Name = "MinBtn"
    minBtn.Size = UDim2.new(0, 34, 0, 34)
    minBtn.Position = UDim2.new(1, -86, 0, 9)
    ...
    minBtn.MouseButton1Click:Connect(function() mainFrame.Visible = not mainFrame.Visible end)  -- simple toggle
    ...
    tabContainer.BackgroundColor3 = Color3.fromRGB(252, 245, 250)
    ...
    searchBox.Size = UDim2.new(1, -24, 0, 48)
    ...
    suggestions.Size = UDim2.new(1, -24, 0, 150)
    suggestions.Position = UDim2.new(0, 12, 0, 64)
    ...
    petImg.Size = UDim2.new(0, 90, 0, 90)
    ...
    petNameLabel.Size = UDim2.new(1, -120, 0, 32)
    petNameLabel.Position = UDim2.new(0, 110, 0, 12)
    petNameLabel.BackgroundTransparency = 1
    petNameLabel.Text = "Pet"
    petNameLabel.TextColor3 = Color3.fromRGB(60, 40, 50)
    petNameLabel.TextSize = 22
    ...
    valueLabel.Size = UDim2.new(1, -120, 0, 40)
    valueLabel.Position = UDim2.new(0, 110, 0, 46)
    ...
    local function performSearch(query)
        ...
        if value then
            ...
            notFound.Visible = false
            -- Animation (scale)
            resultFrame:TweenSize(UDim2.new(1, -24, 0, 180), "Out", "Quad", 0.2, true)
        else
            resultFrame.Visible = false
    ...
    -- Bouton favoris dans le résultat
    local favorites = {}  -- liste des pets favoris (noms)
    ...
    leftAdd.Position = UDim2.new(1, -56, 0, 38)
    ...
    leftList.Size = UDim2.new(1, -12, 1, -82)
    leftList.Position = UDim2.new(0, 6, 0, 78)
    ...
    rightAdd.Position = UDim2.new(1, -56, 0, 38)
    ...
    rightList.Size = UDim2.new(1, -12, 1, -82)
    rightList.Position = UDim2.new(0, 6, 0, 78)
    ...
    evalBtn.Size = UDim2.new(0, 110, 1, -8)
    evalBtn.Position = UDim2.new(1, -120, 0, 4)
    ...
    clearBtn.Size = UDim2.new(0, 80, 1, -8)
    clearBtn.Position = UDim2.new(0.8, -90, 0, 4)
    ...
    for i, theme in ipairs(themes) do
        ...
        btn.MouseButton1Click:Connect(function()
            ...
            -- update tab buttons active color
            for j, tb in ipairs(tabButtons) do
                if j == 1 then -- just simulate active state
            ...
            -- also update search box and result frames (optional)
        end)
    end
    ...
    -- Lancement avec l'onglet Valeur
    switchTab(1)
...
print("✅ Yuno Value (preppy) chargé ! " .. #petValues .. " pets en base.")