--[[
    ...
    Version mobile, corrections d'affichage et calculs précis
]]
...
-- ============================================================================
-- BASE DE DONNÉES DES VALEURS (extraits des captures)
-- ============================================================================
local petValues = {
    -- Haut de gamme
    ...
    ["winged horse"] = 0.6, ["cinnamon"] = 0.01, ["dalmatian"] = 0.01,
    ["dalmatian"] = 61.5,
}
...
-- ============================================================================
-- CRÉATION DE L'INTERFACE (avec corrections)
-- ============================================================================
local function createMainGUI()
    ...
    -- ===== TAB 1 : VALEUR (corrigé pour l'affichage) =====
    ...
    -- Résultat : position relative pour s'adapter à la hauteur
    local resultFrame = Instance.new("Frame")
    resultFrame.Size = UDim2.new(1, -24, 0, 180)
    resultFrame.Position = UDim2.new(0, 12, 0.35, 0)  -- 35% du haut
    ...
    local function performSearch(query)
        ...
        if value then
            ...
            notFound.Visible = false
            -- Animation simplifiée (sans TweenSize pour éviter les bugs)
        else
            resultFrame.Visible = false
    ...
    switchTab(1)
    print("✅ Yuno Value GUI créée avec succès !")
    return screenGui
end
...
print("🚀 Yuno Value chargé ! " .. #petValues .. " pets en base.")