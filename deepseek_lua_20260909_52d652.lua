--[[
    ...
    Version avec bouton flottant fonctionnel, base de données enrichie
]]
...
local petValues = {
    ...
    -- ===== VALEURS EXISTANTES (déjà présentes) =====
    ["bat dragon"] = 943,
    ["shadow dragon"] = 844,
    ["shadow"] = 844,
    ["giraffe"] = 476,
...
-- ============================================================================
-- CRÉATION DE L'INTERFACE (avec bouton flottant fonctionnel)
-- ============================================================================
local function createMainGUI()
    ...
    floatingBtn.Visible = false  -- caché tant que la fenêtre est visible
