...
local Converted = {
	["_YunoHub"] = Instance.new("ScreenGui");
...
Converted["_YunoHub"].DisplayOrder = 3
Converted["_YunoHub"].IgnoreGuiInset = true
Converted["_YunoHub"].ScreenInsets = Enum.ScreenInsets.DeviceSafeInsets
Converted["_YunoHub"].ResetOnSpawn = false
Converted["_YunoHub"].ZIndexBehavior = Enum.ZIndexBehavior.Sibling
Converted["_YunoHub"].Name = "YunoHub"
Converted["_YunoHub"].Parent = game:GetService("CoreGui")

Converted["_Open"].Font = Enum.Font.Gotham
Converted["_Open"].Text = "Triple-click this region to open YunoHub."
...
Converted["_Open"].Parent = Converted["_YunoHub"]
...
Converted["_DropdownFrameSample"].Parent = Converted["_YunoHub"]
...
Converted["_ListButton"].Parent = Converted["_YunoHub"]
...
Converted["_Notifications"].Parent = Converted["_YunoHub"]
...
Converted["_TextBoxPlaceholder"].Parent = Converted["_YunoHub"]
...
Converted["_FloatingButton"].Parent = Converted["_YunoHub"]
...
Converted["_Dropdown"].Parent = Converted["_YunoHub"]
...
Converted["_AddCustomModule"].Parent = Converted["_YunoHub"]
...
Converted["_Menu"].Parent = Converted["_YunoHub"]
...
Converted["_HubName"].Text = "YunoHub "
...
Converted["_TextLabel7"].Text = "YunoHub"
...
Converted["_Toggle"].Parent = Converted["_YunoHub"]
...
Converted["_Modules"].Parent = Converted["_YunoHub"]
...
Converted["_NotificationSample"].Parent = Converted["_YunoHub"]
...
Converted["_Dialog"].Parent = Converted["_YunoHub"]
...
Converted["_Range"].Parent = Converted["_YunoHub"]
...
Converted["_FloatingButtonSetting"].Parent = Converted["_YunoHub"]
...
Converted["_FloatingButtons1"].Parent = Converted["_YunoHub"]

-- Routine Module Scripts:

local routine_module_scripts = {}

do -- Routine Module: StarterGui.YunoHub.FUNCTIONS
    local script = Instance.new("ModuleScript")
    script.Name = "FUNCTIONS"
    script.Parent = Converted["_YunoHub"]
    local function module_script()
		...
		function SBTf()
			...
			-- Implementation by YunoHub Team, respective credits towards the original creators for spring physics
		...
		local YunoHubPointSave = PointSave.new("YunoHub")
		...
		function FUNCTIONSmodule.getTheme()
			if getgenv then
				return getgenv().YunoHub_THEME or FUNCTIONSmodule.theme
			else
		...
		function FUNCTIONSmodule.setTheme(t)
			...
			if getgenv then getgenv().YunoHub_THEME = t end
		end
		...
		function FUNCTIONSmodule.finetuneFloatingButton(button: TextButton, dragger)
			...
			fBSFResizeDragger.Dragged = function(pos)
				...
				button.Size = newSize
				YunoHubPointSave:set(string.gsub(button.Name, "_", ""), udim2Serializer(button.Position) .. "|" .. udim2Serializer(button.Size) .. "|" .. tostring(button.Visible) .. "|" .. tostring(dragger.CanBeDragged))
			end
		...
		function FUNCTIONSmodule.ftToggleLock()
			...
			YunoHubPointSave:set(string.gsub(getgenv().fBSFRealButton.Name, "_", ""), udim2Serializer(getgenv().fBSFRealButton.Position) .. "|" .. udim2Serializer(getgenv().fBSFRealButton.Size) .. "|" .. tostring(getgenv().fBSFRealButton.Visible) .. "|" .. tostring(getgenv().fBSF_ButtonDragger.CanBeDragged))
		end
		...
		function FUNCTIONSmodule.createFloatingButton(item,button,buttonname,fromload)
			if not getgenv().YunoHub.FloatingButtons:FindFirstChild(string.gsub(buttonname, "_", "")) then
				
				
				local UserInputService = game:GetService("UserInputService")
				if not fromload then
					YunoHubPointSave:set(string.gsub(buttonname, "_", ""), udim2Serializer(UDim2.fromOffset(125, 90)) .. "|" .. udim2Serializer(UDim2.fromOffset(200,50)) .. "|true|true")
				end
		
				local newFloatingButton = getgenv().YunoHub.FloatingButton:Clone()
				newFloatingButton.Parent = getgenv().YunoHub.FloatingButtons
				...
				elseif YunoHubPointSave:get(string.gsub(buttonname, "_", "")) then
					local data = YunoHubPointSave:get(string.gsub(buttonname, "_", "")):split("|")
				...
				floatingButtonDraggers[string.gsub(buttonname, "_", "")].Dragged = function(newPos)
					YunoHubPointSave:set(string.gsub(buttonname, "_", ""), udim2Serializer(newPos) .. "|" .. udim2Serializer(newFloatingButton.Size) .. "|" .. tostring(newFloatingButton.Visible) .. "|" .. tostring(floatingButtonDraggers[string.gsub(buttonname, "_", "")].CanBeDragged))
				end
				...
				YunoHubPointSave:remove(string.gsub(buttonname, "_", ""))
				task.spawn(function()
					local buttontodestroy = getgenv().YunoHub.FloatingButtons:FindFirstChild(string.gsub(buttonname, "_", ""))
			...
			for _, module in ipairs(getgenv().Modules) do
				for _, item in ipairs(module) do
					if item["Type"] == "Button" then
						...
						local saved = YunoHubPointSave:get(key)
						if saved then
		...
		function FUNCTIONSmodule.loader(module)
			...
			for _, item in ipairs(module) do
				...
				elseif item["Type"] == "Input" then
					local cloneinput = getgenv().YunoHub.TextBoxPlaceholder:Clone()
				...
				elseif item["Type"] == "Toggle" then
					local clonetoggle = getgenv().YunoHub.Toggle:Clone()
				...
				elseif item["Type"] == "Dropdown" then	
					local clonedropdown = getgenv().YunoHub.Dropdown:Clone()
					local dropdownFrame = getgenv().YunoHub.DropdownFrameSample
				...
				elseif item["Type"] == "Range" then
					local clonerange = getgenv().YunoHub.Range:Clone()
		...
		function FUNCTIONSmodule.refreshlist()
			...
			for i, module in ipairs(dense) do
				local success, err = pcall(function()
					...
					local listbutton = getgenv().YunoHub.ListButton:Clone()
				...
				if not success then
					warn(("[YunoHub] Error loading module %q: %s"):format(module.Name, err))
				end
			end
		end
		...
		getgenv().YunoHubFUNCTIONS = FUNCTIONSmodule
		return FUNCTIONSmodule
		
    end
    routine_module_scripts[script] = module_script
end
do -- Routine Module: StarterGui.YunoHub.DraggableObject
    local script = Instance.new("ModuleScript")
...
do -- Routine Module: StarterGui.YunoHub.ClickAndHold
    local script = Instance.new("ModuleScript")
...
do -- Routine Module: StarterGui.YunoHub.Spring
    local script = Instance.new("ModuleScript")
    script.Name = "Spring"
    script.Parent = Converted["_YunoHub"]
    local function module_script()
...
do -- Routine Module: StarterGui.YunoHub.ESPIndicator
    local script = Instance.new("ModuleScript")
    ...
    local function module_script()
		...
		-- Designed and written by YunoHub
...
do -- Routine Module: StarterGui.YunoHub.Bezier
    local script = Instance.new("ModuleScript")
    script.Name = "Bezier"
    script.Parent = Converted["_YunoHub"]
    local function module_script()
...
do -- Routine Module: StarterGui.YunoHub.PointSave
    local script = Instance.new("ModuleScript")
...
do -- Routine Module: StarterGui.YunoHub.Theme
    local script = Instance.new("ModuleScript")
    script.Name = "Theme"
    script.Parent = Converted["_YunoHub"]
    local function module_script()

		-- Beautiful theming module for YunoHub
		
		local YunoHubRoot = getgenv().YunoHub
		local api = {
			colors = {
				font = Enum.Font.Montserrat,
				textColor = Color3.fromRGB(255, 255, 255),
...
do -- Routine Module: StarterGui.YunoHub.FlyUtility
    local script = Instance.new("ModuleScript")
...
local function WMYX_routine() -- Routine: StarterGui.YunoHub.Flee the Facility
...
local function CEBY_routine() -- Routine: StarterGui.YunoHub.Universal
    local script = Instance.new("LocalScript")
	...
	--table.insert(module, {
	--	Type = "Text",
	--	Args = {"Welcome to YunoHub! The open, free script hub."}
	--})
	
	table.insert(module, {
		Type = "Text",
		Args = {"<font color='#FFFF00'>Another great script</font> by YunoHub developers below!"}
	})
	
	table.insert(module, {
		Type = "Button",
		Args = {"AFEM Max - The best AI-powered emote script!", function()
			loadstring(game:HttpGet("https://yunohub.mhi.im/scr?channel=afemmax"))()
	...
	table.insert(module, {
		Type = "Button",
		Args = {"Hide YunoHub", function(Self)
			...
			elseif uis.AccelerometerEnabled then
				...
				fu.notification("Can't hide YunoHub!") -- how else are you gonna open???
			end
		end,}
	}
	)
	...
	table.insert(module, {
		...
		Args = {"Open developer console (debugging)", function(Self)
			...
			--getgenv().YunoHub.Open.UIStroke.Transparency = 0
			--getgenv().YunoHub.Open.TextTransparency = 0
			--ts:Create(getgenv().YunoHub.Open, TweenInfo.new(1, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out), {
			--	Position = UDim2.fromScale(0.5, 0.903)
			--}):Play()
	
			--ts:Create(getgenv().YunoHub.Open.UIStroke, TweenInfo.new(1), {
			--	Transparency = 1
			--}):Play()
			--ts:Create(getgenv().YunoHub.Open, TweenInfo.new(1), {
			--	TextTransparency = 1
			--}):Play()
		end}
	}
	...
	local function loadThemeFromSave(last)
		...
		if YunoHubPointSave:get("YunoHubGlobal_themeCode") then
			local themeObjectImport = themeDeserialize(https:JSONDecode(fu.from_base64(YunoHubPointSave:get("YunoHubGlobal_themeCode"))))
			theme:setColorTable(themeObjectImport)
			theme:init(getgenv().YunoHub)
	...
	table.insert(module, {
		...
		Args = {
			...
			function(obj, value)
				...
				YunoHubPointSave:set("YunoHubGlobal_themeCode", value)
			end
		}
	})
	...
	table.insert(module, {
		...
		Args = {"Delete theme from save", function()
			YunoHubPointSave:remove("YunoHubGlobal_themeCode")
	...
	--		return https:JSONDecode(game:HttpGet("https://yunohub.mhi.im/static/ingametitles.json"))
	--	end)
	...
	--table.insert(module, {
	--	Type = "Toggle",
	--	Args = {"Hide YunoHub+/Developer tags", function(_, state)
	...
	--table.insert(module, {
	--	Type = "Dropdown",
	--	Args = {"how rizz is yunohub", {"very rizz", "no rizz"}, function(Self, item)
	--		print(item)
	--	end,}
	--})
...
local function DSZIHQM_routine() -- Routine: StarterGui.YunoHub.Init
    local script = Instance.new("LocalScript")
    script.Name = "Init"
    script.Parent = Converted["_YunoHub"]
    local req = require
	...
	local s, e = pcall(function()
		if get_hidden_gui or gethui then
			...
			--print("[YunoHub] - Using get_hidden_gui for anti-detection.")
		elseif (not is_sirhurt_closure) and (syn and syn.protect_gui) then
			script.Parent.Name = randomString()
			syn.protect_gui(script.Parent)
			script.Parent.Parent = COREGUI
			--print("[YunoHub] - Using syn.protect_gui for anti-detection.")
		elseif COREGUI:FindFirstChild('RobloxGui') then
			script.Parent.Parent = COREGUI.RobloxGui
			--print("[YunoHub] - Using RobloxGui for anti-detection.")
		else
			--warn("[YunoHub] - Using CoreGui as anti-detection. This is the most basic coverage and can still be detected.")
		end
	end)
	
	--print("[YunoHub] - YunoHub is now in " .. tostring(script.Parent:GetFullName()))
	if not s then
		--warn("[YunoHub] - Attempts at anti-detection failed. Using CoreGui as anti-detection.")
		warn(e)	
	end
	
	--printidentity("[YunoHub] - Your executor level (identity) is")
	
	local getExeName = identifyexecutor or getexecutorname or function() return "Yet Another Roblox Executor v1.2" end
	--print("[YunoHub] - Your executor is " .. getExeName())
	...
	--require(script.Parent.FUNCTIONS).notification("Welcome to YunoHub Nebula.")
	...
	--require(script.Parent.Theme):init(getgenv().YunoHub)
...
local function EXEKBZ_routine() -- Routine: StarterGui.YunoHub.Forsaken
    local script = Instance.new("LocalScript")
	...
	local fu = require(getgenv().YunoHub.FUNCTIONS)
	if (module.gameId ~= game.GameId) then
		table.insert(module, {
			Type = "Text",
			Args = {"YunoHub now includes an official <font color='#FFFF00'>Forsaken</font> module!"}
		})
		table.insert(module, {
			Type = "Text",
			Args = {"<font size='10'>To use, run YunoHub on Forsaken.</font>"}
		})
		repeat task.wait() until getgenv().Modules
...
local function XXZOB_routine() -- Routine: StarterGui.YunoHub.Murder Mystery 2
    local script = Instance.new("LocalScript")
	...
	local function getPredictedPosition(player, shootOffset)
		...
		if predictionAIEngine and not usingBasicPred and not predictionCooldown and getgenv().YunoHubNetwork_predictPos then
			if (playerPosition - localplayer.Character:FindFirstChild("UpperTorso").Position).Magnitude > 20 then
				...
				local predictedPosition = getgenv().YunoHubNetwork_predictPos(ogplayer)
		...
		elseif predictionAIEngine and not getgenv().YunoHubNetwork.predictPos then
			fu.notification("YunoHub AI Engine is not available. Reverting to basic prediction.")	
		end
	...
	--					task.wait(0.1)
	--					local murderer = findMurderer() or findSheriffThatsNotMe()
	--					if not murderer then warn("[YunoHub] > MM2 Autoshoot - No murderer.") continue end
	--					local murdererPosition = murderer.Character.HumanoidRootPart.Position
	--					local characterRootPart = localplayer.Character.HumanoidRootPart
...
local function ONOAH_routine() -- Routine: StarterGui.YunoHub.Open.InitOpen
    local script = Instance.new("LocalScript")
...
local function JFQXCG_routine() -- Routine: StarterGui.YunoHub.Open.OnClick
    local script = Instance.new("LocalScript")
    script.Name = "OnClick"
    script.Parent = Converted["_Open"]
    local req = require
	...
	script.Parent.MouseButton1Click:Connect(function()
		...
		if clickCount == 3 then
			...
			ts:Create(getgenv().YunoHub.Menu, TweenInfo.new(0.7, Enum.EasingStyle.Back, Enum.EasingDirection.Out), 
...
local function EJGX_routine() -- Routine: StarterGui.YunoHub.Open.Resizer
    local script = Instance.new("LocalScript")
    script.Name = "Resizer"
    script.Parent = Converted["_Open"]
    local req = require
...
local function FRPPL_routine() -- Routine: StarterGui.YunoHub.FloatingButton.Keybinding
    local script = Instance.new("LocalScript")
...
local function VOBA_routine() -- Routine: StarterGui.YunoHub.FloatingButton.Invisible
    local script = Instance.new("LocalScript")
...
local function SZSARYI_routine() -- Routine: StarterGui.YunoHub.AddCustomModule.Add.LocalScript
    local script = Instance.new("LocalScript")
	...
	task.wait(1.5)
	if game.gameId == 5794311181 then loadModule("https://yunohub.mhi.im/static/cnasim.yrmdl") end -- CNA Simulator
end
local function UVBTWP_routine() -- Routine: StarterGui.YunoHub.AddCustomModule.Cancel.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function HCWF_routine() -- Routine: StarterGui.YunoHub.Menu.UIStroke.UIGradient.Animator
    local script = Instance.new("LocalScript")
...
local function AWDPHWS_routine() -- Routine: StarterGui.YunoHub.Menu.CloseArea.CloseOpen
    local script = Instance.new("LocalScript")
...
local function VTLALB_routine() -- Routine: StarterGui.YunoHub.Menu.List.AutoSetup
    local script = Instance.new("LocalScript")
...
local function TVLRH_routine() -- Routine: StarterGui.YunoHub.Menu.List.AddCustomModule.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function KUFNO_routine() -- Routine: StarterGui.YunoHub.FloatingButtonSetting.ControlBarContainer.ControlBar.Visibility.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	script.Parent.MouseButton1Click:Connect(function()
		getgenv().YunoHubFUNCTIONS.ftToggleVisibility()
	end)
end
local function XLYNZG_routine() -- Routine: StarterGui.YunoHub.FloatingButtonSetting.ControlBarContainer.ControlBar.Lock.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	script.Parent.MouseButton1Click:Connect(function()
		getgenv().YunoHubFUNCTIONS.ftToggleLock()
	end)
end
local function XAPKH_routine() -- Routine: StarterGui.YunoHub.FloatingButtonSetting.ControlBarContainer.ControlBar.Exit.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	script.Parent.MouseButton1Click:Connect(function()
		getgenv().YunoHubFUNCTIONS.closeFinetuneFB()
	end)
end
