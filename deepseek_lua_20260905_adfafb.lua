...
-- Added Theme Tab with color schemes and font selection.
-- ============================================================
...
petsPanel.Size = UDim2.new(1, 0, 0, 330)
...
themePanel.Size = UDim2.new(1, 0, 0, 200)
themePanel.BackgroundTransparency = 1
themePanel.LayoutOrder = 1
themePanel.Visible = false
themePanel.Parent = content

-- ============================================================
-- Pets Panel (same as before)
-- ============================================================
...
for _, themeName in ipairs({"Default", "Rose", "WhiteGold", "DarkGold"}) do
    ...
    btn.MouseButton1Click:Connect(function()
        ...
        -- update theme tab appearance to indicate selection
...
fontDropdownBtn.Position = UDim2.new(0.2, 0, 0, 0) -- will be overridden by layout
...
fontListFrame.Position = UDim2.new(0.2, 0, 0, 0)
